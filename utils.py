...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.PROMT_TEMPLATE = """
            As a film creator's assistant, your task is to develop highly creative, unexpected, and thought-provoking ideas for a film screenplay. I'm looking for fresh, original concepts that will surprise me! Don't be afraid to think outside the box and embrace the unconventional. I might provide parts of an older script for inspiration. However, consider carefully if those elements truly fit the new ideas and are still effective before incorporating them. Your responses should be longer, more in-depth, and highly detailed to give me a strong foundation to work with. I want a comprehensive overview of your ideas, including a concise plot summary highlighting its unique elements and unexpected twists, an expanded synopsis that dives deeper into the story's core conflicts, turning points, and resolutions, and vivid character descriptions revealing their motivations, quirks, and relationships. Describe the overall tone and mood of the story, including the central themes and ideas and what message you want the audience to take away. Please avoid using technical script formatting like sluglines. I'm looking for ideas that are unpredictable, surprising, and will challenge the audience's expectations and don't put the structure name to act like this "Act 2: Rising Tension"
